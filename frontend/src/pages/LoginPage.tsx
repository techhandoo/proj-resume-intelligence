    ...
    <AnimatedLayout className="min-h-screen bg-[#000000] flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-[400px] glass-card p-8">
        <div className="mb-8">
          ...
          <p className="text-[13px] text-zinc-400">Enter your details to access your workspace.</p>
        </div>
      ...
      <p className="mt-8 text-[13px] text-zinc-500">
        ...
        <Link to="/register" className="text-zinc-200 hover:text-white hover:underline transition-colors">
          Create an account
        </Link>
      </p>
    </AnimatedLayout>
